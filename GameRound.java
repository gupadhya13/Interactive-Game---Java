...
public class GameRound {
	...
	public void setClueWord(String clueWord) {
		this.clueWord.set(clueWord);
	}

	public StringProperty clueWordProperty() {
		return clueWord;
	}

	// isRoundComplete
	public boolean getIsRoundComplete() {
		return isRoundComplete.get();
	}

	public void setIsRoundComplete(boolean isRoundComplete) {
		this.isRoundComplete.set(isRoundComplete);
	}

	public BooleanProperty isRoundCompleteProperty() {
